...
The box's width ramps from 2rem to 6rem as the container grows from 16rem to 48rem. Since the demo container has a minimum resizable width around 12rem, the box never overflows.
