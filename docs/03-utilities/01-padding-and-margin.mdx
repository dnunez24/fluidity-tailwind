...
All eighteen utilities come in three curve variants — linear, exponential, and logarithmic — that differ only in how smoothly they transition between min and max:
...
Variants stack freely and work as you'd expect with any other Tailwind utility.
