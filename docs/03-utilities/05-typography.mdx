...
:::warning
**Important:** Because the ratio multiplier scales from the min value, and min is 0em, the bare `f6y-tracking` is a **constant 0em, not a ramp** — 0em × any ratio is still 0em.
